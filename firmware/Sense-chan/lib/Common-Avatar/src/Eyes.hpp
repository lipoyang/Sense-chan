...
class BaseEye : public Drawable {
   ...
   public:
    ...
    void update(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx);
};

class EllipseEye : public BaseEye {
   public:
    using BaseEye::BaseEye;
    void draw(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx);
};

class GirlyEye : public BaseEye {
   public:
    using BaseEye::BaseEye;
    void drawEyeLid(LGFX_Sprite *canvas);
