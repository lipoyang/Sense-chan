...
void BaseEyebrow::update(LGFX_Sprite *canvas, BoundingRect rect,
                         DrawContext *ctx) {
...
void EllipseEyebrow::draw(LGFX_Sprite *canvas, BoundingRect rect,
                          DrawContext *ctx) {
...
void BowEyebrow::draw(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx) {
    this->update(canvas, rect, ctx);
    uint8_t thickness = 4;
...
void RectEyebrow::draw(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx) {
    this->update(canvas, rect, ctx);
