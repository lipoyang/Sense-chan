...
class BatteryIcon final : public Drawable {
 private:
  void drawBatteryIcon(LGFX_Sprite *spi, uint32_t x, uint32_t y, uint16_t fgcolor, uint16_t bgcolor, float offset, BatteryIconStatus batteryIconStatus, int32_t batteryLevel) {
