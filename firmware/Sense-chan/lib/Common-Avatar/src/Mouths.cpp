...
void BaseMouth::update(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx) {
...
void RectMouth::draw(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx) {
...
void OmegaMouth::draw(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx) {
    this->update(canvas, rect, ctx);  // update drawing cache
...
void UShapeMouth::draw(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx) {
    this->update(canvas, rect, ctx);  // update drawing cache
    uint32_t h = min_height_ + (max_height_ - min_height_) * open_ratio_;
    uint32_t w = min_width_ + (max_width_ - min_width_) * (1 - open_ratio_);
...
void DoggyMouth::draw(LGFX_Sprite *canvas, BoundingRect rect, DrawContext *ctx) {
